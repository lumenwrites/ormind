				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'image-attachment' ); ?>>
					<header class="entry-header">
						...
						<nav id="image-navigation" class="navigation" role="navigation">
							<span class="previous-image"><?php previous_image_link( false, __( '&laquo; Previous Image', 'wpstarter' ) ); ?></span>
							<span class="next-image"><?php next_image_link( false, __( 'Next Image &raquo;', 'wpstarter' ) ); ?></span>
